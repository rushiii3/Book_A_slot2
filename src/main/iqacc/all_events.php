...
if(isset($_POST['all_events'])){
    ...
    if($year==''){
        ...
        echo("<script>window.location='../iqac/report.php';</script>");
    }
...
<div class="container-fluid mt-3">
        ...
        <div class='col-lg-5 col-md-5 mt-5 m-auto'>
            <div class='container d-flex align-items-center justify-content-center '  id='card' style='height:50vh'>
            <h2 class='text-center'>No Record found in this month of <?php echo $year;?></h2>
